...
def main():
    ...
    final_loss_wo_reg, theta_wo_reg = logistic_regression(X_original, Y_original, max_iter=100000, lambda_reg=0)
    
    #Baseline with regularization
    final_loss_w_reg, theta_w_reg = logistic_regression(X_original, Y_original, max_iter=100000, lambda_reg=10)
